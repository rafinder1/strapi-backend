...
export interface ApiJobApplicationJobApplication
  ...
  attributes: {
    ...
    phone: Schema.Attribute.BigInteger;
    publishedAt: Schema.Attribute.DateTime;
    statusApplication: Schema.Attribute.Enumeration<
      [
        'nowy',
        'w trakcie recenzji',
...
export interface ApiJobOfferJobOffer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Umowa o prac\u0119'>;
    jobApplications: Schema.Attribute.Relation<
      'oneToMany',
      'api::job-application.job-application'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Warszawa'>;
